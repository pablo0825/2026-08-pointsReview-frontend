import type { PublicApplicationSuccessResponse } from '../api/public-application.schema'

export function ApplicationUncertainState({
  onRetry,
  onEdit,
  pending,
}: {
...
export function ApplicationSuccessPage({
  ...
  result: PublicApplicationSuccessResponse['data']
}) {
