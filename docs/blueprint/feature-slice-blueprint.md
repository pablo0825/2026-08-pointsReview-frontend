...
| FS-004 | `competition-application` | feature | FS-003 | none | none | approved | shared point allocation 與學年度顯示修訂已核准；等待開始 R4，實作全員 0.00、自訂 0.50 加減／手動輸入、摘要上移，以及畫面隱藏但 payload 保留學年度。 | 2026-08-14 |
