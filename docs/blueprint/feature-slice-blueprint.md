...
| FS-002 | `published-instructions` | feature | none | none | none | awaiting-approval | 已確認類型選擇、選擇前不查詢、`displayOrder` 排序及 `200` 空陣列的 empty 行為；公開端點的 visibility 保證仍待確認。 | 2026-08-11 |
