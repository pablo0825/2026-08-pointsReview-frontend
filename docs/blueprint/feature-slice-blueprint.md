...
| FS-004 | `competition-application` | feature | FS-003 | none | none | awaiting-approval | Human Acceptance 提出確認摘要與進度列修訂：移除分配方式與區塊修改按鈕、申請人與聯絡資料置頂，只允許進度列返回前面已完成步驟；等待重新核准 Spec、Plan 與 Commit Plan。 | 2026-08-14 |
