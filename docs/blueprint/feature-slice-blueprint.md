...
| FS-002 | `published-instructions` | feature | none | none | none | awaiting-approval | 已確認以四個固定文案的大型按鈕選擇類型且選擇前不查詢，並由前端依 `displayOrder` 排列同類型、同年度的 sections；empty／visibility 行為仍待確認。 | 2026-08-11 |
