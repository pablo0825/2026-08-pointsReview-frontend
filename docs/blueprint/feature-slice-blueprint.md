...
| FS-004 | `competition-application` | feature | FS-003 | none | none | awaiting-human | R4 與完整 AI Verification 已通過：shared 全員 0.00、自訂 0.50 加減／手動輸入、摘要上移，畫面隱藏學年度但 payload 保留；等待 Human Integration 與 Human Acceptance。 | 2026-08-14 |
