...
| FS-004 | `competition-application` | feature | FS-003 | none | none | proposed | 已補充共用申請表架構責任、成功頁與未登入公開送件契約，尚未開始 Spec。 | 2026-08-12 |
| FS-005 | `project-participation-application` | feature | FS-003 | none | none | proposed | 已補充未登入公開送件契約，尚未開始 Spec。 | 2026-08-12 |
| FS-006 | `certificate-application` | feature | FS-003 | none | none | proposed | 已補充未登入公開送件契約；證照正規化契約待確認。 | 2026-08-12 |
| FS-007 | `exhibition-application` | feature | FS-003 | none | none | proposed | 已補充未登入公開送件契約，尚未開始 Spec。 | 2026-08-12 |
