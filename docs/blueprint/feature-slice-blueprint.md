...
| FS-002 | `published-instructions` | feature | none | none | none | awaiting-approval | Human Integration 發現初版每個類型產生重複 request；使用者要求改為單次查詢，修訂後 Spec、Plan 與 Commit Plan 等待重新核准。 | 2026-08-11 |
