...
| FS-002 | `published-instructions` | feature | none | none | none | awaiting-approval | 公開辦法 API 已確認四種 `applicationType`、選填 `academicYear` 及 section 陣列；頁面類型選擇方式與 section 排序仍待確認。 | 2026-08-11 |
