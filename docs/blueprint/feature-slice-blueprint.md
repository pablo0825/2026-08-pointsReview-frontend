...
| FS-004 | `competition-application` | feature | FS-003 | none | none | awaiting-human | R5 與完整 AI Verification 已完成；確認摘要、申請人置頂、進度列返回與 payload 原順序均有自動化證據，等待 Human Integration 與 Human Acceptance。 | 2026-08-14 |
