...
| FS-004 | `competition-application` | feature | FS-003 | none | none | awaiting-approval | 已核准「競賽內容」先於「參與者資料」的流程變更提案；修訂後 Spec、Plan 與 R1／Reverification Commit Plan 待重新核准。 | 2026-08-13 |
