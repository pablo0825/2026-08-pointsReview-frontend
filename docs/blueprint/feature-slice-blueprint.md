...
| FS-007 | `exhibition-application` | feature | FS-003 | none | none | awaiting-approval | Shared Understanding 已確認且 Boundary Gate 已通過；Draft Spec／Plan 已建立，等待使用者核准。 | 2026-08-18 |
