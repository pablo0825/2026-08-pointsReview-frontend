...
| FS-002 | `published-instructions` | feature | none | none | none | awaiting-approval | 公開辦法 API 已確認 `applicationType` 必填、`academicYear` 選填及 section 陣列；類型 enum、頁面選擇方式與 section 排序仍待確認。 | 2026-08-11 |
...
| FS-007 | `exhibition-application` | feature | FS-003 | none | none | proposed | 已由第一版需求建立，尚未開始 Spec。 | 2026-08-10 |
