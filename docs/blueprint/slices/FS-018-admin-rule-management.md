...
## Goal
讓管理員以版本方式維護四類點數規則與參與人數規則。

## User-Visible Result
管理員可查看規則、建立新版本及提前停用，既有申請仍使用首次送件時規則。
...
## Included
- 點數／人數規則列表、新版本、提前停用與有效期間呈現。

## Excluded
- 覆寫歷史版本、規則外點數、個案核准與申請辦法內容。

## AI Responsibility
- 在契約確認後完成規則管理、版本安全、測試與文件。

## Human Integration
- 確認 Rules 完整契約及版本衝突規則，提供歷史與未來規則資料。

## AI Acceptance
- 自動驗證版本建立、提前停用、各類欄位、權限與錯誤狀態。

## Human Acceptance
- 管理員建立與停用測試規則，確認公開選項與既有申請規則不被改寫。
