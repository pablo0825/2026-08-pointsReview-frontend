...
## Included
- 參與者、明確選擇申請人、申請人卡片內聯絡資料、未選申請人的錯誤與焦點、學籍、競賽資料、有效規則、點數分配、老師、附件、預覽、離開警告與 multipart 送件。
...
## AI Acceptance
- 自動驗證初始未選申請人、聯絡資料卡片位置、未選錯誤與焦點、改選清除、唯一申請人 payload、兩種分配、規則切換／失效、單次查詢、動態人數、學號正規化／重複、歷史／未來日期、附件、確認摘要、離開警告、錯誤定位、5xx Idempotent retry、衝突／Rate Limit 及成功頁。

## Human Acceptance
- 使用者確認明確選擇申請人與卡片內聯絡資料流程，完成 `per_person` 與多人 `shared_total` 真實送件，並確認成功頁正確顯示申請編號、目前狀態、送件時間與 Email 通知提醒，且不顯示老師簽核期限。
