...
- `src/features/rules/published-instructions-page.test.tsx`：驗證標題、四個固定文案按鈕與順序，以及 MSW 初始未選擇／零 request、類型隔離、年度切換、loading、empty、error、retry、success 與 stale result 防護。
